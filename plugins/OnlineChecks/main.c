    ...
    )
{
    ...
    PhInsertEMenuItem(onlineMenuItem, PhPluginCreateEMenuItem(PluginInstance, 0, MENUITEM_JOTTI_UPLOAD_FILE, L"上传文件到&Jotti...", NULL), ULONG_MAX);
    ...
    case DLL_PROCESS_ATTACH:
        {
            ...
            info->Description = L"允许使用在线服务对文件进行扫描.";
