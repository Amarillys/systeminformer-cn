...
{
    SIP(SREF(L"未知"), 0),
    SIP(SREF(L"断开"), MIB_TCP_STATE_CLOSED),
    SIP(SREF(L"监听"), MIB_TCP_STATE_LISTEN),
    SIP(SREF(L"SYN 已发送"), MIB_TCP_STATE_SYN_SENT),
    SIP(SREF(L"SYN 已接收"), MIB_TCP_STATE_SYN_RCVD),
    SIP(SREF(L"建立"), MIB_TCP_STATE_ESTAB),
    SIP(SREF(L"FIN 等待 1"), MIB_TCP_STATE_FIN_WAIT1),
    SIP(SREF(L"FIN 等待 2"), MIB_TCP_STATE_FIN_WAIT2),
    SIP(SREF(L"等待关闭中"), MIB_TCP_STATE_CLOSE_WAIT),
    SIP(SREF(L"断开中"), MIB_TCP_STATE_CLOSING),
    SIP(SREF(L"上一次 ACK"), MIB_TCP_STATE_LAST_ACK),
    SIP(SREF(L"等待中"), MIB_TCP_STATE_TIME_WAIT),
    SIP(SREF(L"删除 TCB"), MIB_TCP_STATE_DELETE_TCB),
    SIP(SREF(L"绑定"), MIB_TCP_STATE_RESERVED),
};
